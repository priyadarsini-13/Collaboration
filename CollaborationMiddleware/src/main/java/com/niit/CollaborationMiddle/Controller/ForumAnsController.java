...
//	@GetMapping("/allforumans")
//	ResponseEntity<List<ForumAnswer>> selectAllForumAnswer(@RequestParam("forumid")int id)
//	{
//		Forum forum=forumdao.selectOneForum(id);
//		ArrayList<ForumAnswer> forumanslist=forumansdao.selectAllForumAnswer(forum);
//		if(forumanslist.isEmpty())
//		{
//			return new ResponseEntity<List<ForumAnswer>>(HttpStatus.NOT_FOUND);
//		}
